...
const Import = () => {
  ...
  return (
    <div>
      <div className='bg-white m-3'>
        ...
        <div className="mr-5 p-5 flex justify-between items-center" style={{ float: 'right', width: '100%' }}>
          ...
          <div className="flex items-center">
            ...
            />
            <button className="bg-indigo-600 text-white p-2 rounded-md flex items-center ml-2" onClick={() => setIsEditModalOpen(true)}>
              <LuPlus />
      ...
      <AddImportModal isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
